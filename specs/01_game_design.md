...
## 13. Редкости предметов

| Редкость | key | Множитель | Уровни предмета | Кол-во статов |
|---|---|---:|---:|---:|
| Обычный | common | 1.0 | 1–3 | 1 |
| Необычный | uncommon | 1.25 | 2–5 | 1–2 |
| Редкий | rare | 1.6 | 4–8 | 2–3 |
| Эпический | epic | 2.2 | 7–10 | 3 |

Максимальный уровень предмета в MVP: `10`.

10 уровень возможен только для `epic`.
...
3. Если предмет выпал — выбирается rarity по rarity_chances локации.
4. Выбираются доступные item_templates через dungeon_location_item_templates.
5. Templates фильтруются по классу героя.
6. Выбирается item_template.
7. По rarity выбирается item_level.
8. По rarity выбирается количество статов.

...
EQUIPMENT_KINDS: tuple[EquipmentKind, ...] = (
    EquipmentKind(
        ...
        stats={"attack": {"min": 2, "max": 4}, "defense": {"min": 1, "max": 2}},
    ),
    EquipmentKind(
        key="dagger",
        slot="weapon",
        ...
        stats={"attack": {"min": 2, "max": 4}, "critical_chance": {"min": 1, "max": 2}},
    ),
    EquipmentKind(
        key="staff",
        slot="weapon",
        ...
        stats={"attack": {"min": 2, "max": 5}, "critical_chance": {"min": 1, "max": 2}},
    ),
    EquipmentKind(
        key="bow",
        slot="weapon",
        ...
        stats={"attack": {"min": 2, "max": 4}, "evasion": {"min": 1, "max": 2}},
    ),
    EquipmentKind(
        key="ring",
        slot="ring",
        ...
        stats={"critical_chance": {"min": 1, "max": 2}, "max_hp": {"min": 3, "max": 6}},
    ),
    EquipmentKind(
        key="armor",
        slot="armor",
        item_type="armor",
        allowed_classes=None,
        stats={"max_hp": {"min": 6, "max": 12}, "defense": {"min": 1, "max": 3}},
    ),
    EquipmentKind(
        key="boots",
        slot="boots",
        item_type="boots",
        allowed_classes=None,
        stats={"evasion": {"min": 1, "max": 2}, "defense": {"min": 1, "max": 2}},
    ),
    EquipmentKind(
        key="helmet",
        slot="helmet",
        item_type="helmet",
        allowed_classes=None,
        stats={"max_hp": {"min": 4, "max": 8}, "defense": {"min": 1, "max": 2}},
    ),
)

...
from .views import (
    ...
    CraftPotionView,
    CraftRecipeListView,
    DungeonAutoRunStopView,
    DungeonAutoRunSummaryReadView,
...
urlpatterns = [
    ...
    path("dungeons/<int:pk>/resources", DungeonLocationResourcesView.as_view(), name="dungeon_resources"),
    ...
    path("dungeon-auto-runs/current/stop", DungeonAutoRunStopView.as_view(), name="dungeon_auto_run_stop"),
    path("dungeon-auto-runs/current/summary/read", DungeonAutoRunSummaryReadView.as_view(), name="dungeon_auto_run_summary_read"),
    ...
    path("craft/recipes", CraftRecipeListView.as_view(), name="craft_recipes"),
    path("craft/potions", CraftPotionView.as_view(), name="craft_potions"),
    path("shop/offers", ShopOfferListView.as_view(), name="shop_offers"),
    path("shop/offers/<int:pk>", ShopOfferDetailView.as_view(), name="shop_offer_detail"),
    path("shop/offers/<int:pk>/buy", BuyShopOfferView.as_view(), name="shop_offer_buy"),
    path("shop/purchases", ShopPurchasesView.as_view(), name="shop_purchases"),
